...
public class XListView extends ListView {
     ...
     * Pass this to {@link #setUndoStyle(com.sashapps.WhoBringsWhat.XListView.UndoStyle)}
     ...
     * Use {@link #setSwipeDirection(com.sashapps.WhoBringsWhat.XListView.SwipeDirection)}
    ...
    /**
     * The callback interface used by {@link #setShouldSwipeCallback(com.sashapps.WhoBringsWhat.ItemList.XListView.OnShouldSwipeCallback)}
    ...
    public interface OnShouldSwipeCallback {
         ...
         *
         * @param listView The {@link com.sashapps.WhoBringsWhat.ItemList.XListView} the item is wiping from.
         * @param position The position of the item to swipe in your adapter.
         * @return Whether the item should be swiped or not.
         */
        boolean onShouldSwipe(XListView listView, int position);

    }

    /**
     * The callback interface used by {@link #setDismissCallback(com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback)}
    ...
    public interface OnDismissCallback {
         ...
         * depends on your data and adapter, the {@link com.sashapps.WhoBringsWhat.XListView}
         ...
         * of {@link com.sashapps.WhoBringsWhat.XListView.Undoable} from this method.
         ...
         *
         * @param listView The {@link com.sashapps.WhoBringsWhat.ItemList.XListView} the item has been deleted from.
         * @param position The position of the item to delete from your adapter.
         * @return An {@link com.sashapps.WhoBringsWhat.XListView.Undoable}, if you want
         * to give the user the possibility to undo the deletion.
         */
        Undoable onDismiss(XListView listView, int position);

    }

    /**
     * Extend this abstract class and return it from
     * {@link com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback#onDismiss(com.sashapps.WhoBringsWhat.ItemList.XListView, int)}
     * to let the user undo the deletion you've done with your {@link com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback#onDismiss(com.sashapps.WhoBringsWhat.ItemList.XListView, int)} and reinsert
         ...
         * (whereas in {@link com.sashapps.WhoBringsWhat.XListView.OnDismissCallback#onKeyDown(int, android.view.KeyEvent)}
     ...
     * {@link com.sashapps.WhoBringsWhat.XListView.OnDismissCallback#onDismiss(com.sashapps.WhoBringsWhat.ItemList.XListView, int)}
     * of the given {@link com.sashapps.WhoBringsWhat.XListView} will be called. To enable
     * <i>undo</i> of the deletion, return an {@link com.sashapps.WhoBringsWhat.XListView.Undoable}
     * from {@link com.sashapps.WhoBringsWhat.XListView.OnDismissCallback#onDismiss(com.sashapps.WhoBringsWhat.ItemList.XListView, int)}.
     ...
     *
     * @return The {@link com.sashapps.WhoBringsWhat.XListView}
     * @throws IllegalStateException when you haven't passed an {@link com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback}
     *                               to {@link #setDismissCallback(com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback)} before calling this
     *                               method.
     */
    public XListView enableSwipeToDismiss() {
     ...
     *
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView disableSwipeToDismiss() {
        mSwipeEnabled = false;
        return this;
    }
     ...
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setDismissCallback(OnDismissCallback dismissCallback) {
     ...
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setShouldSwipeCallback(OnShouldSwipeCallback shouldSwipeCallback) {
        mShouldSwipeCallback = shouldSwipeCallback;
        return this;
    }

    /**
     * Sets the undo style of this list. See the javadoc of {@link com.sashapps.WhoBringsWhat.XListView.UndoStyle}
     * for a detailed explanation of the different styles. The default style (if you never call this
     * method) is {@link com.sashapps.WhoBringsWhat.XListView.UndoStyle#SINGLE_POPUP}.
     *
     * @param undoStyle The style of this listview.
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setUndoStyle(UndoStyle undoStyle) {
     ...
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setUndoHideDelay(int hideDelay) {
     ...
     */
    public XListView setRequireTouchBeforeDismiss(boolean touchBeforeDismiss) {
     ...
     * By default this is set to {@link com.sashapps.WhoBringsWhat.ItemList.XListView.SwipeDirection#BOTH} so that an item
     ...
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setSwipeDirection(SwipeDirection direction) {
     ...
     * @return This {@link com.sashapps.WhoBringsWhat.XListView}
     */
    public XListView setSwipingLayout(int swipingLayoutId) {
     ...
     * {@link com.sashapps.WhoBringsWhat.ItemList.XListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException     when this method is called before an {@link com.sashapps.WhoBringsWhat.ItemList.XListView.OnDismissCallback}
     *                                   is set via {@link #setDismissCallback(com.sashapps.WhoBringsWhat.XListView.OnDismissCallback)}.
     */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getActionMasked()) {
                ...
                for (int i = getHeaderViewsCount(); i < childCount; i++) {
                    ...
                    if (child != null) {
                        ...
                        if (rect.contains(x, y)) {
                            ...
                            mSwipeDownView = mSwipeDownView != null ? mSwipeDownView : child;

                            if (lastPos != INVALID_POSITION && lastPos != i && mIsRevealed == true) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                /* Decide whether to complete action */

                // Dismiss conditions
                if (Math.abs(deltaX) > mViewWidth / 2 && mSwiping && deltaX > 0) {
                    dismiss = true;
                } else if (mMinFlingVelocity <= velocityX && velocityX <= mMaxFlingVelocity
                        && velocityY < velocityX && mSwiping && isSwipeDirectionValid(mVelocityTracker.getXVelocity())
                        && deltaX >= mViewWidth * 0.35f && mVelocityTracker.getXVelocity() > 0
                        && (mSwipeDownView == null || (mSwipeDownView != null && mSwipeDownView.getTranslationX() == 0))
                        ) {
                    dismiss = true;
                }
                // Reveal Condition
                ...
                if (dismiss && !mIsRevealed) {
                    // dismiss
                    slideOutView(mSwipeDownChild, mSwipeDownChild, mDownPosition, dismissRight);
                    mReveleadDistance = 0;
                } else if (reveal) { // Reveal to max
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    ...
                    if (isSwipingRight) { // Dismiss

                        //ViewHelper.setTranslationX(mRevealView, 0); // if back layout is revealed, dismiss it

                        /*if (Math.abs(ViewHelper.getTranslationX(mRevealView)) > 0) {
                            ViewHelper.setTranslationX(mRevealView, 0);
                            mReveleadDistance = 0;
                        } else {
    ...
    private void performDismiss(final View dismissView, final View listItemView, final int dismissPosition) {
        ...
        //android.animation.Animator anim = android.animation.ValueAnimator.ofInt(originalHeight,)
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (noAnimationLeft) {
                    ...
                    for (PendingDismissData dismiss : mPendingDismisses) {
                        ...
                        Undoable undoable = mDismissCallback.onDismiss(XListView.this, dismiss.position);
                        if (undoable != null) {
                    ...
                    if (!mUndoActions.isEmpty()) {
                        ...
                        mUndoPopup.showAtLocation(XListView.this,
     ...
     * {@link #setSwipeDirection(com.sashapps.WhoBringsWhat.XListView.SwipeDirection)}
     *
